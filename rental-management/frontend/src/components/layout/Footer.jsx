            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        <Link to="/" className="flex items-center mb-4">
                            <span className="text-2xl font-bold text-blue-400">RentalHub</span>
                        </Link>
                        <p className="text-gray-300 mb-4">
                            Your trusted partner for all rental needs. We provide a seamless platform
                            to rent products with flexible pricing and reliable service.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li>
                                <Link to="/returns" className="text-gray-300 hover:text-blue-400 transition-colors">
                                    Return Policy
                                </Link>
                            </li>
                        </ul>
                ...
                <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
                    ...
                    <div className="flex space-x-6 mt-4 md:mt-0">
                        <span className="text-gray-300 text-sm">Made with ❤️ for renters</span>
                    </div>
                </div>
            </div>
        </footer>
